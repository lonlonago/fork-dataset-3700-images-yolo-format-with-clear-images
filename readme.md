# Fork dataset (3700 images YOLO format with clear images

# Body

Fork dataset, 3700 images in YOLO format, clear images, complete annotations, suitable for target detection model training, ready to use, saves time and effort
